...
var Client = module.exports = function (options) {
  ...
  this.handleResponse = once(this.handleResponse);
  bindAll(this);
...
client.request = function (options) {
  ...
  this.runHandlers(this.opt, null, null, function () {
    ...
    that.ticlient.onload = that.handleResponseWithoutError;
...
client.handleResponse = function (err) {
  ...
  this.runHandlers(this.opt, res, err, function () {
    that.send(!!err ? err : null, !!err ? null : res);
  });
};

/* Call handleResponse and force no-error */

client.handleResponseWithoutError = function () {
  this.handleResponse();
};
